...
IUSE="debug nethack pam selinux multiuser topstat"
...
src_prepare() {
	...
	use topstat && sed -i 's/#undef TOPSTAT/#define TOPSTAT/g' config.h.in || die
...
src_configure() {
	...
	use topstat && append-cppflags -DTOPSTAT
